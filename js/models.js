...
export function newDutyEntry() {
  ...
  const entry = {
    ...
    arrivalTime: null,
    arrivalAt: "",
    arrivalHogFromTime: null,
    arrivalHogToTime: null,
    arrivalTakeoverFrom: "",
    arrivalTakeoverTime: null,
    arrivalDepartureTime: null,
    arrivalSignalNumber: "",
    arrivalPlacedTime: null,
    arrivalPlace: "",
    arrivalDetachTime: null,
    arrivalPmName: "",
    arrivalYardDepartureTime: null,
    arrivalYardSignal: "",
    arrivalShedArrivalTime: null,
    arrivalLineNumber: "",
    lastModified: now,
  };
